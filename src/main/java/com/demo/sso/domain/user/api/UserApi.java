...
public interface UserApi {
    ...
    @Operation(summary = "로그인 API", security = {})
    @ApiResponses(
    ...
    ResponseEntity<SuccessResponse> logout(@UserId Long userId);
    ...
    @DeleteMapping("user")
    ResponseEntity<SuccessResponse> deleteUser(@UserId Long userId);
